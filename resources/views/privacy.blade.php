<x-layout.app :headerCondensed="true" bgImage="img/privacy_policy.jpg">
  <x-slot name="pageTitle">Privacy Policy</x-slot>
  ...
  <section class="pt-10">
    <div class="container">
      <div class="mb-2 text-right">
        <br><strong>Last Updated On 26-Mar-2023</strong>
        <br><strong>Effective Date 26-Mar-2023</strong>
      </div>

      <p class="privacy-policy-p mb-1">
        This Privacy Policy describes the policies of

        Leica Florian Robert,
        Via P. Maraschin 44B,
        Vi
        36015,
        Italy,
        ...
        when you use our website ( leicaflorianrobert.dev ).
      ...
      <p class="privacy-policy-p text-right  mt-3">
